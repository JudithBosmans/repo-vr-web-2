...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    const folders = ref([]);
    [__temp, __restore] = withAsyncContext(() => useAsyncData("folders", () => queryContent("/").sort({ numbernavigation: 1 }).find())), __temp = await __temp, __restore(), __temp;
...
//# sourceMappingURL=FolderNavigation-DPbSJ0px.js.map
