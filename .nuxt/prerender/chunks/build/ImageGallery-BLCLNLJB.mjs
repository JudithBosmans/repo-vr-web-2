...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    [__temp, __restore] = withAsyncContext(() => useAsyncData("post", () => queryContent(actualPath).findOne())), __temp = await __temp, __restore();
    ref(false);
    ref("");
...
//# sourceMappingURL=ImageGallery-BLCLNLJB.mjs.map
