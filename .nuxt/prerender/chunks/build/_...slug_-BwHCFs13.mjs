import _sfc_main$1 from './ContentQuery-C801UXpm.mjs';
import { mergeProps, withCtx, createVNode, resolveDynamicComponent, openBlock, createBlock, useSSRContext } from 'file:///Users/judith.b/Desktop/24-25/LUCA/WEB-DESIGN/repo-vr-web-2/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderVNode } from 'file:///Users/judith.b/Desktop/24-25/LUCA/WEB-DESIGN/repo-vr-web-2/node_modules/vue/server-renderer/index.mjs';
import { L as Layout5, a as Layout4, b as Layout3, c as Layout2, _ as _sfc_main$4 } from './Layout5-CX5iDAfk.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_ContentQuery, {
        ...
        default: withCtx(({ data }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ssrRenderVNode(_push2, createVNode(resolveDynamicComponent(getLayoutComponent(data.layoutblog)), {
              data,
              formatDate
            }, null), _parent2, _scopeId);
          } else {
            return [
              (openBlock(), createBlock(resolveDynamicComponent(getLayoutComponent(data.layoutblog)), {
                data,
                formatDate
              }, null, 8, ["data"]))
            ];
...
//# sourceMappingURL=_...slug_-BwHCFs13.mjs.map
