import { ref, defineComponent, computed, openBlock, createElementBlock, mergeProps, unref, renderSlot, provide, watch, createVNode, h, useSlots, createBlock, withCtx, Transition, withDirectives, createElementVNode, withModifiers, normalizeClass, toDisplayString, createCommentVNode, vShow, useSSRContext, inject, getCurrentInstance, nextTick, withAsyncContext, warn, isRef, onScopeDispose, Teleport as Teleport$1 } from 'file:///Users/judith.b/Desktop/24-25/LUCA/WEB-DESIGN/repo-vr-web-2/node_modules/vue/index.mjs';
...
import { isString, NOOP, isObject, hasOwn, camelize } from 'file:///Users/judith.b/Desktop/24-25/LUCA/WEB-DESIGN/repo-vr-web-2/node_modules/@vue/shared/dist/shared.cjs.prod.js';
import { o as useNamespace, p as isUndefined, k as isNumber, l as isStringNumber, m as debugWarn, v as useZIndex, w as useId, z as useFetch, t as throwError, s as isBoolean, x as defaultNamespace, y as useState, _ as _export_sfc$1 } from './server.mjs';
...
import { ssrRenderComponent, ssrRenderAttrs, ssrInterpolate } from 'file:///Users/judith.b/Desktop/24-25/LUCA/WEB-DESIGN/repo-vr-web-2/node_modules/vue/server-renderer/index.mjs';
import { _ as __nuxt_component_0 } from './nuxt-link-aeFFRLeD.mjs';
import _sfc_main$9 from './MainNavigation-DW17bEHy.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(_attrs)} data-v-7664a10c><div class="footer text-xs mt-5" data-v-7664a10c><div class="flex" data-v-7664a10c><div class="flex basis-11/12" data-v-7664a10c>`);
  _push(ssrRenderComponent(_component_ColorMode, null, null, _parent));
  _push(`</div><div class="flex basis-1/12 p-10" data-v-7664a10c><div class="flex-1 basis-5/12 pr-1" data-v-7664a10c>`);
  _push(ssrRenderComponent(_component_NuxtLink, { to: "/" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" viewBox="0 0 24 24" data-v-7664a10c${_scopeId}><path fill="currentColor" d="M5.692 19V9.946L2.604 12.25L2 11.458L12 4l4.346 3.223V5h1.885v3.639l3.788 2.819l-.603.792l-3.089-2.304V19h-5.096v-5.23h-2.462V19zm1-1H9.77v-5.23h4.462V18h3.096V9.21L12 5.256L6.692 9.21zm3.5-7.994h3.616q0-.704-.542-1.159q-.543-.455-1.266-.455t-1.265.453t-.543 1.16M9.77 18v-5.23h4.462V18v-5.23H9.769z" data-v-7664a10c${_scopeId}></path></svg>`);
      } else {
        return [
  ...
  _push(`</div><div class="flex-1 basis-5/12 pr-1" data-v-7664a10c>`);
  _push(ssrRenderComponent(_component_NuxtLink, { to: "/search" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" viewBox="0 0 24 24" data-v-7664a10c${_scopeId}><path fill="currentColor" d="M9.539 15.23q-2.398 0-4.065-1.666Q3.808 11.899 3.808 9.5t1.666-4.065T9.539 3.77t4.064 1.666T15.269 9.5q0 1.042-.369 2.017t-.97 1.668l5.909 5.907q.14.14.15.345q.009.203-.15.363q-.16.16-.354.16t-.354-.16l-5.908-5.908q-.75.639-1.725.989t-1.96.35m0-1q1.99 0 3.361-1.37q1.37-1.37 1.37-3.361T12.9 6.14T9.54 4.77q-1.991 0-3.361 1.37T4.808 9.5t1.37 3.36t3.36 1.37" data-v-7664a10c${_scopeId}></path></svg>`);
      } else {
        return [
          (openBlock(), createBlock("svg", {
            xmlns: "http://www.w3.org/2000/svg",
  ...
  _push(`</div><div class="flex-1 basis-5/12 pr-1 text-right" data-v-7664a10c>`);
  ...
  _push(ssrRenderComponent(_component_NuxtLink, { to: "/dash" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" viewBox="0 0 24 24" data-v-7664a10c${_scopeId}><path fill="currentColor" d="M3.135 17.442q-.171-.17-.171-.365t.17-.365l5.307-5.306q.459-.46 1.136-.46t1.137.46l2.401 2.402q.193.192.462.183q.27-.01.442-.222l6.208-7.128q.14-.172.338-.172q.197 0 .362.147q.14.14.153.325q.012.186-.128.351l-6.206 7.166q-.46.534-1.155.562q-.697.028-1.206-.482l-2.366-2.365Q9.846 12 9.577 12t-.442.173l-5.27 5.27q-.151.151-.355.16t-.375-.16" data-v-7664a10c${_scopeId}></path></svg>`);
      } else {
        return [
          (openBlock(), createBlock("svg", {
            xmlns: "http://www.w3.org/2000/svg",
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc$1(_sfc_main$3, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-7664a10c"]]);
const _sfc_main$2 = {
  __name: "utilNav",
  __ssrInlineRender: true,
  async setup(__props) {
...
//# sourceMappingURL=Drawer-By_gAcDd.mjs.map
