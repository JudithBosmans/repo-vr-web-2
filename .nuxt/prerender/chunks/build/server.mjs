import { hasInjectionContext, inject, version, ref, watchEffect, watch, getCurrentInstance, h, defineAsyncComponent, shallowRef, toRef, onServerPrefetch, isRef, computed, toValue, reactive, unref, defineComponent, useSSRContext, provide, shallowReactive, Suspense, nextTick, Fragment, Transition, createApp, effectScope, getCurrentScope, onErrorCaptured, createVNode, resolveDynamicComponent, mergeProps, isReadonly, isShallow, isReactive, toRaw } from 'file:///Users/judith.b/Desktop/24-25/LUCA/WEB-DESIGN/repo-vr-web-2/node_modules/vue/index.mjs';
...
import { RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file:///Users/judith.b/Desktop/24-25/LUCA/WEB-DESIGN/repo-vr-web-2/node_modules/vue-router/dist/vue-router.node.mjs';
...
import defu$1, { defu } from 'file:///Users/judith.b/Desktop/24-25/LUCA/WEB-DESIGN/repo-vr-web-2/node_modules/defu/dist/defu.mjs';
...
const _routes = [
  {
    name: "slug",
    path: "/:slug(.*)*",
    component: () => import('./document-driven-T5qQY5oE.mjs')
  },
  {
    name: "blog-slug",
    path: "/blog/:slug(.*)*",
    component: () => import('./_...slug_-BwHCFs13.mjs')
  },
  {
    name: "blog",
    path: "/blog",
    component: () => import('./index-H20qT9lI.mjs')
  },
  {
    name: "collection-slug",
    path: "/collection/:slug(.*)*",
    component: () => import('./_...slug_-CkXUqRLf.mjs')
  },
  {
    name: "collection",
    path: "/collection",
    component: () => import('./index-2I1A3sBV.mjs')
  },
  {
    name: "dash",
    path: "/dash",
    component: () => import('./dash-CYDj96xa.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-B_MtG9q8.mjs')
  },
  {
    name: "page-slug",
    path: "/page/:slug(.*)*",
    component: () => import('./_...slug_-DnZGRb7T.mjs')
  },
  {
    name: "page",
    path: "/page",
    component: () => import('./index-XN09pLHJ.mjs')
  },
  {
    name: "search",
    path: "/search",
    component: () => import('./search-DZnjW2Ff.mjs')
  },
  {
    name: "tags-slug",
    path: "/tags/:slug()",
    component: () => import('./_slug_-D9kQSfPb.mjs')
  }
];
...
const LazyBlogNavigation = defineAsyncComponent(() => import('./BlogNavigation-Bfy1B-Lm.mjs').then((r) => r["default"] || r.default || r));
const LazyFolderContent = defineAsyncComponent(() => import('./FolderContent-B4CB10x4.mjs').then((r) => r["default"] || r.default || r));
const LazyFolderNavigation = defineAsyncComponent(() => import('./FolderNavigation-Cawf8wV4.mjs').then((r) => r["default"] || r.default || r));
const LazyHomepageImage = defineAsyncComponent(() => import('./HomepageImage-CKRcGC_Z.mjs').then((r) => r["default"] || r.default || r));
const LazyImageGallery = defineAsyncComponent(() => import('./ImageGallery-BLCLNLJB.mjs').then((r) => r["default"] || r.default || r));
const LazyMainNavigation = defineAsyncComponent(() => import('./MainNavigation-Clcws3Cg.mjs').then((r) => r["default"] || r.default || r));
const LazyPageNavigation = defineAsyncComponent(() => import('./PageNavigation-DrSoc8Z2.mjs').then((r) => r["default"] || r.default || r));
const LazyPromotedContent = defineAsyncComponent(() => import('./PromotedContent-BJmN4cnn.mjs').then((r) => r["default"] || r.default || r));
const LazyRelatedPages = defineAsyncComponent(() => import('./RelatedPages-0xxdMqVm.mjs').then((r) => r["default"] || r.default || r));
const LazyNavsBlogNavigation = defineAsyncComponent(() => import('./BlogNavigation-D09_a5Aa.mjs').then((r) => r["default"] || r.default || r));
const LazyNavsFolderNavigation = defineAsyncComponent(() => import('./FolderNavigation-pzF-uS29.mjs').then((r) => r["default"] || r.default || r));
const LazyNavsMainNavigation = defineAsyncComponent(() => import('./MainNavigation-BmCN6jAd.mjs').then((r) => r["default"] || r.default || r));
const LazyNavsPageNavigation = defineAsyncComponent(() => import('./PageNavigation-ILXgNTlr.mjs').then((r) => r["default"] || r.default || r));
const LazyContentDoc = defineAsyncComponent(() => import('./ContentDoc-sl9aWxzS.mjs').then((r) => r["default"] || r.default || r));
const LazyContentList = defineAsyncComponent(() => import('./ContentList-DQNsVvAT.mjs').then((r) => r["default"] || r.default || r));
const LazyContentNavigation = defineAsyncComponent(() => import('./ContentNavigation-0CN3R4ar.mjs').then((r) => r["default"] || r.default || r));
const LazyContentQuery = defineAsyncComponent(() => import('./ContentQuery-C801UXpm.mjs').then((r) => r["default"] || r.default || r));
const LazyContentRenderer = defineAsyncComponent(() => import('./ContentRenderer-C7gskBj6.mjs').then((r) => r["default"] || r.default || r));
const LazyContentRendererMarkdown = defineAsyncComponent(() => import('./ContentRendererMarkdown-DTDnO7C8.mjs').then((r) => r["default"] || r.default || r));
const LazyContentSlot = defineAsyncComponent(() => import('./ContentSlot-CzI_O8PT.mjs').then((r) => r["default"] || r.default || r));
...
const LazyMarkdown = defineAsyncComponent(() => import('./Markdown-DZFRa2ii.mjs').then((r) => r["default"] || r.default || r));
const LazyProseCode = defineAsyncComponent(() => import('./ProseCode-DKypvgyU.mjs').then((r) => r["default"] || r.default || r));
const LazyProseCodeInline = defineAsyncComponent(() => import('./ProseCodeInline-EqTGPJld.mjs').then((r) => r["default"] || r.default || r));
const LazyProsePre = defineAsyncComponent(() => import('./ProsePre-ClSanD6H.mjs').then((r) => r["default"] || r.default || r));
const LazyProseA = defineAsyncComponent(() => import('./ProseA-SQP8AODZ.mjs').then((r) => r["default"] || r.default || r));
const LazyProseBlockquote = defineAsyncComponent(() => import('./ProseBlockquote-DPDiTg45.mjs').then((r) => r["default"] || r.default || r));
const LazyProseEm = defineAsyncComponent(() => import('./ProseEm-gCKkrw8K.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH1 = defineAsyncComponent(() => import('./ProseH1-PYaFkv06.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH2 = defineAsyncComponent(() => import('./ProseH2-B96MpCot.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH3 = defineAsyncComponent(() => import('./ProseH3-L65B3Lop.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH4 = defineAsyncComponent(() => import('./ProseH4-Cy4nsh4c.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH5 = defineAsyncComponent(() => import('./ProseH5-wPQzvDQh.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH6 = defineAsyncComponent(() => import('./ProseH6-BE4yBk8s.mjs').then((r) => r["default"] || r.default || r));
const LazyProseHr = defineAsyncComponent(() => import('./ProseHr-C0cYC90P.mjs').then((r) => r["default"] || r.default || r));
const LazyProseImg = defineAsyncComponent(() => import('./ProseImg-DGqB9_8z.mjs').then((r) => r["default"] || r.default || r));
const LazyProseLi = defineAsyncComponent(() => import('./ProseLi-DuPU165s.mjs').then((r) => r["default"] || r.default || r));
const LazyProseOl = defineAsyncComponent(() => import('./ProseOl-jrIRIwqy.mjs').then((r) => r["default"] || r.default || r));
const LazyProseP = defineAsyncComponent(() => import('./ProseP-DUPIkIgY.mjs').then((r) => r["default"] || r.default || r));
const LazyProseScript = defineAsyncComponent(() => import('./ProseScript-D0R07iM6.mjs').then((r) => r["default"] || r.default || r));
const LazyProseStrong = defineAsyncComponent(() => import('./ProseStrong-Bfc6vz9l.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTable = defineAsyncComponent(() => import('./ProseTable-aGE3wQke.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTbody = defineAsyncComponent(() => import('./ProseTbody-BnvEQHHk.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTd = defineAsyncComponent(() => import('./ProseTd-lMHdd516.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTh = defineAsyncComponent(() => import('./ProseTh-D9lIvyck.mjs').then((r) => r["default"] || r.default || r));
const LazyProseThead = defineAsyncComponent(() => import('./ProseThead-CUp0egwj.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTr = defineAsyncComponent(() => import('./ProseTr-g8iB_Rzv.mjs').then((r) => r["default"] || r.default || r));
const LazyProseUl = defineAsyncComponent(() => import('./ProseUl-9wcLzkzd.mjs').then((r) => r["default"] || r.default || r));
...
const ipxRuntime$IbLQljIDEU = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  getImage,
  supportsAlias,
  validateDomains
...
imageOptions.providers = {
  ["ipx"]: { provider: ipxRuntime$IbLQljIDEU, defaults: {} }
};
const useImage = () => {
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-BzFAHw7D.mjs').then((m) => m.useContentDatabase());
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-BzFAHw7D.mjs').then((m) => m.generateNavigation);
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-Du8F9XkN.mjs').then((m) => m.default || m)),
  page: defineAsyncComponent(() => import('./page-DGF5AECX.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-YtYoKJwp.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DCDGfanu.mjs'));
...
export { defaultInitialZIndex as A, isUndefined as B, isBoolean as C, useId as D, useState as E, useFetch as F, parseSize as G, useImage as H, prerenderStaticImages as I, _sfc_main$3 as J, fetchContentNavigation as K, LayoutMetaSymbol as L, get as M, assertArray as N, ensureArray as O, PageRouteSymbol as P, omit as Q, sortList as R, apply as S, withoutKeys as T, withKeys as U, createQuery as V, _export_sfc as _, useNuxtApp as a, useRoute as b, appLayoutTransition as c, _wrapIf as d, entry$1 as default, useRuntimeConfig as e, useContent as f, useRequestEvent as g, useAsyncData as h, useRouter as i, navigateTo as j, useContentPreview as k, layouts as l, isNumber as m, nuxtLinkDefaults as n, isStringNumber as o, debugWarn as p, queryContent as q, resolveRouteObject as r, isWindow as s, throwError as t, useHead as u, useNamespace as v, namespaceContextKey as w, defaultNamespace as x, useZIndex as y, zIndexContextKey as z };
