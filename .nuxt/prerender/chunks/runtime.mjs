...
import { parseURL, withoutBase, joinURL, getQuery, withQuery, decodePath, withLeadingSlash, withoutTrailingSlash, isRelative } from 'file:///Users/judith.b/Desktop/24-25/LUCA/WEB-DESIGN/repo-vr-web-2/node_modules/ufo/dist/index.mjs';
...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "6d6b4bb8-a6ea-4af8-b452-9dba2865eb8f",
  ...
  "nitro": {
    ...
    "routeRules": {
      ...
      "/api/_content/search-1736011980752": {
        "prerender": true,
        "headers": {
...
const _lazy_ARU6Bk = () => import('./_/renderer.mjs').then(function (n) { return n.r; });
...
const handlers = [
  ...
  { route: '/api/_content/cache.1736011980752.json', handler: _sSc2Uy, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/search-1736011980752', handler: _bPuD6t, lazy: false, middleware: false, method: "get" },
