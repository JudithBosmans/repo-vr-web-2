    ...
    <ClientOnly>
        ...
        >
          <div class="container p-4">
            <div>
              ...
              <h1
                v-if="data.subtitle"
                class="layoutDescription text-white opacity-80 pt-3 text-xl md:text-2xl lg:text-3xl font-bold pb-10"
              >
                {{ data.subtitle }}
              </h1>
            </div>
      ...
      >
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
          <!-- First column -->
          <div>
            <h1 class="text-3xl md:text-3xl lg:text-6xl lg:mb-3 font-bold">
              {{ data.title }}
            </h1>
            <h1
              v-if="data.subtitle"
            ...
            <p class="text-lg md:text-2xl lg:text-xl pb-5 font-bold">
              {{ data.description }}
            </p>
