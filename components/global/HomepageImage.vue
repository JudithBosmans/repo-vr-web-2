...
<template>
  <div>
    <div v-if="isLoading" class="flex items-center justify-center h-screen">
      <p>Loading...</p>
      <!-- Display loading text or spinner while data is being fetched -->
    </div>
    ...
    <div
      ...
      :style="{
        backgroundImage: settings.thumbnail ? `url(${settings.thumbnail})` : '',
      }"
    >
      <div class="pr-5">
        <Drawer />
      ...
      <div class="info flex flex-col items-center justify-center h-screen">
        <div class="container text-left p-1 lg:p-20">
          <div
            class="container opacity-80 animate-fade animate-once animate-delay-[100ms] p-10 lg:p-20 bg-white dark:bg-black bg-opacity-80 dark:bg-opacity-80"
          >
